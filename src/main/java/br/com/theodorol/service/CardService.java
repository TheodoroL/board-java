...
import br.com.theodorol.exception.CardBlockedException;
import br.com.theodorol.exception.CardFinishedException;
import br.com.theodorol.exception.EntityNotFoundException;
import br.com.theodorol.percistence.dao.BlockDAO;
...
import static br.com.theodorol.percistence.entity.BoardColumnKindEnum.FINAL;
...
public class CardService {
    ...
    public void cancel( Long cardId,  Long cancelColumnId ,
                        List<BoardColumnInfoDTO> boardColumnsInfo) throws SQLException{
        try{
            var dao = new CardDAO(connection);
            var optional = dao.findById(cardId);
            var dto = optional.orElseThrow(
